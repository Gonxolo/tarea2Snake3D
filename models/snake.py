...
class Head():
    ...
    def __init__(self):
        ...
        self.transform = tr.matmul([tr.translate(0.0,0.0,-9.5),tr.uniformScale(0.5),tr.rotationZ(self.theta)])
    ...
    def move(self):
        ...
        self.transform = tr.matmul([tr.translate(self.x,self.y,-9.5),tr.uniformScale(0.5),tr.rotationZ(self.theta)])
...
class Snake():
    ...
    def growth(self):
        ...
        self.snake_parts[-1].x, self.snake_parts[-1].y, self.snake_parts[-1].theta = self.positions[-3*(len(self.snake_parts)-1)]
